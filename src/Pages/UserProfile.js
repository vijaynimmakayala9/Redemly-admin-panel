...
//   const renderCategoryTimeSpentSection = () => {
//     const categoryData = user.categoryTimeSpent || {};
//     const categories = Object.keys(categoryData).filter(key => 
//       typeof categoryData[key] === 'object' && categoryData[key] !== null
//     );

//     return (
//       <div>
//         <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-4 sm:mb-6">Category Time Spent</h2>
...
//                       <p className="text-base sm:text-lg font-bold mt-1">{data.formatted || '0h 0m 0s'}</p>
//                     </div>
//                     <div className="bg-gray-50 p-3 rounded">
//                       <p className="text-xs sm:text-sm text-gray-600">Hours</p>
//                       <p className="text-base sm:text-lg font-bold mt-1">{data.hours || 0}</p>
//                     </div>
//                     <div className="bg-gray-50 p-3 rounded">
//                       <p className="text-xs sm:text-sm text-gray-600">Minutes</p>
//                       <p className="text-base sm:text-lg font-bold mt-1">{data.minutes || 0}</p>
//                     </div>
//                     <div className="bg-gray-50 p-3 rounded">
//                       <p className="text-xs sm:text-sm text-gray-600">Seconds</p>
//                       <p className="text-base sm:text-lg font-bold mt-1">{data.seconds || 0}</p>
//                     </div>
//                   </div>
                  
//                   {data.note && (
//                     <p className="mt-3 text-xs sm:text-sm text-gray-500 italic">{data.note}</p>
//                   )}
//                 </div>
//               );
//             })}
...
//             </svg>
//             <p className="mt-2 text-sm sm:text-base text-gray-600">No category activity data available</p>
//           </div>
//         )}
//       </div>
//     );
